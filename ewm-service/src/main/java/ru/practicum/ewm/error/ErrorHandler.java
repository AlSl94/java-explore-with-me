...
public class ErrorHandler {
    ...
    public ExceptionResponse handleAlreadyExistsException(final AlreadyExistsException e) {
        ...
        return new ExceptionResponse(e.getMessage(), "CONFLICT",
                ErrorState.CONFLICT);
    }
    ...
    public ExceptionResponse handleNotFoundException(final NotFoundException e) {
        ...
        return new ExceptionResponse(e.getMessage(), "NOT_FOUND",
                ErrorState.NOT_FOUND);
    }

    @ExceptionHandler(ValidationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ExceptionResponse handleValidateException(final ValidationException e) {
        log.error("Validate Exception - " + e.getMessage());
        return new ExceptionResponse(e.getMessage(), "BAD_REQUEST",
    ...
    public ExceptionResponse handleFeignStatusException(FeignException e, HttpServletResponse response) {
        response.setStatus(e.status());
        log.error("Feign Exception - " + e.getMessage());
        return new ExceptionResponse(e.getMessage(), "SERVICE_UNAVAILABLE",
